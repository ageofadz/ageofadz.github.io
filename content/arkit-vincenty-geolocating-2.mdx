...
One of the increasingly interesting use cases for AR is the ability to have persistent virtual content appearing in real-life locations, such as informational graphics outside of major landmarks, or directional content along a route. This
...
There are really two technical challenges in this use case:

- How do I save local coordinates
